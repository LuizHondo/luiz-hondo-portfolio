  ...
  <section className="flex min-h-screen items-center justify-center px-4 pt-16">
    <div className="container max-w-3xl text-center">
      ...
      >
        Front-End Developer
        <br />
        <span className="text-primary">& Mobile Enthusiast</span>
      </motion.h1>
      <motion.p
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        I build clean, performant, and accessible web & mobile experiences with React, React Native, and modern JavaScript.
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
